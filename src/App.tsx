        ...
        {filteredTransactions.map((t) => (
          ...
          >
            ...
            <div className="relative flex-shrink-0 pt-0.5 sm:pt-0">
              ...
              <div className="absolute right-0 top-full mt-1 hidden w-36 bg-white rounded-xl shadow-lg border border-slate-100 z-50 peer-focus:block hover:block overflow-hidden">
                <button
